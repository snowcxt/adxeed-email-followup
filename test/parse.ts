...
//         expect(result).to.equal('<p>Hey <strong>adf</strong>.</p>');
//     });
...
//         expect(result).to.equal('<p>Hey <strong>bold1</strong> and<strong>bold2</strong></p>');
//     });
...
//         expect(result).to.equal('<p>Hey <strong>{{variable1}}.</strong>{{variable1}}</p>');
//     });
...
//         expect(result).to.equal('<p><strong>Hey</strong> <strong>{{variable1}}.</strong>{{variable1}} abc <strong>{{variable1}}</strong></p>');
//     });
...
//         expect(result).to.equal('<p><strong>Hey</strong> <strong>{{variable1}}.</strong>{{variable1}} abc <strong>{{variable1}}</strong></p><p><strong>Block2 </strong>hi {{variable1}} these a new block</p>');
//     });
// });
